...
export const BENCHMARK_MODELS: ModelBenchmarkRecord[] = [
  {
    ...
    输入价格_美元: 5.00,
    输出价格_美元: 20.00,
    核心优势: "中转生态最高倍率标杆型号（中转站 gpt-6-astra 常规 5x~37.5x）；新一代多步反思与工具自主调用鲁棒性业界登顶。",
    短板风险: "上游号池极端稀缺，调用单价昂贵；部分低质中转站存在拿低阶模型冒充或降智风险，需配合质检中心严密打点。",
    推荐场景: "企业级核心自动化业务、复杂多智能体编排 (Multi-Agent Swarm)、高价值科研算法攻坚。",
    官方发布时间: "2026-06",
  },
  {
    模型名称: "Claude Fable 5 (Thinking)",
    厂商: "Anthropic",
    家族系列: "Claude",
    模型定位: "深度思考推理",
    梯队评级: "S+ 顶尖旗舰",
    ...
    输入价格_美元: 5.00,
    输出价格_美元: 25.00,
    核心优势: "Anthropic 前瞻探索性实验架构（中转站主流代号 claude-fable-5）；长程思考力与自主代理执行力达到划时代水准。",
    短板风险: "中转站多为实验特供渠道，配额极为紧俏，部分小站存在拿 3.7 或 3.5 伪造路由风险。",
    推荐场景: "全自主端到端 AI Agent、极复杂系统架构拆解、高壁垒交叉学科推导。",
    官方发布时间: "2026-03",
  },
  {
    模型名称: "Claude Opus 4.6 (Thinking)",
    厂商: "Anthropic",
    家族系列: "Claude",
    模型定位: "深度思考推理",
    梯队评级: "S+ 顶尖旗舰",
    ...
    输入价格_美元: 15.00,
    输出价格_美元: 75.00,
    核心优势: "Anthropic 超大满血旗舰（中转站 claude-opus-4-6）；代码重构深度与学术思辨力天花板，思维链缜密无瑕。",
    短板风险: "官方单价极度高昂 ($15/$75 每百万 tokens)，中转站若倍率异常偏低必有猫腻（掺水或截断）。",
    推荐场景: "核心商业资产代码重构、前沿专利与学术专著审校、重大商业战略严密复盘。",
    官方发布时间: "2025-11",
  },
  {
    ...
    输入价格_美元: 15.00,
    输出价格_美元: 75.00,
    核心优势: "经典的文学文采与学术论述标杆；人格化回答极其自然细腻，对微妙情感与复杂隐喻的理解力至今无出其右。",
    短板风险: "初代 Opus，纯代码与极限奥数基准已被 3.7 / 4.x 反超，最大输出限制在 4K，调用成本较高。",
    推荐场景: "长篇文学创作、哲学社会学深度阐释、高敏感公文润色、经典学术文献精读。",
    官方发布时间: "2024-03",
  },
  {
    模型名称: "GPT-5.6 Sol (Reasoning)",
    厂商: "OpenAI",
    家族系列: "GPT",
    模型定位: "深度思考推理",
    梯队评级: "S+ 顶尖旗舰",
    ...
    输入价格_美元: 2.50,
    输出价格_美元: 10.00,
    核心优势: "GPT-5.6 满血重算力推理版，Juice 预算充沛；数学竞赛与全工程级代码缺陷修复具备工业最高可靠度。",
    短板风险: "中转生态掺水高发区（常被偷换为 Terra 或 Luna），官方基准单价 $2.5/1M，选站时需核验 Juice 指纹一致性。",
    推荐场景: "重度工程重构、复杂数理仿真、全自主 AI 软件工程师、学术级严密论证。",
    官方发布时间: "2026-04",
  },
  {
    模型名称: "GPT-5.6 Terra (Balanced)",
    厂商: "OpenAI",
    家族系列: "GPT",
    模型定位: "通用旗舰多模态",
    梯队评级: "S 头部第一梯队",
    ...
    输入价格_美元: 1.00,
    输出价格_美元: 4.00,
    核心优势: "GPT-5.6 走量主力；吞吐速度快，通用认知与日常复杂任务性能卓越，综合性价比最高。",
    短板风险: "极限深度数学奥赛表现弱于 Sol；部分站点定价不透明。",
    推荐场景: "日常主力编码结对、高精度文档总结、业务中台日常调用、高要求客服系统。",
    官方发布时间: "2026-04",
  },
  {
    模型名称: "GPT-5.6 Luna (Flash/Fast)",
    厂商: "OpenAI",
    家族系列: "GPT",
    模型定位: "性价比轻量",
    梯队评级: "A+ 高性价比主力",
    ...
    输入价格_美元: 0.15,
    输出价格_美元: 0.60,
    核心优势: "极致首字延迟 (TTFT < 200ms) 与极低调用成本；高并发场景下的极速蒸馏架构。",
    短板风险: "长流程复杂推理易遗漏细节边界；常被黑心站点伪造成 Sol 牟取暴利。",
    推荐场景: "流式实时交互助手、海量日志分类、轻量结构化数据清洗、初步信息过滤。",
    官方发布时间: "2026-04",
  },
  {
    模型名称: "Google Gemini 3.0 Pro",
    厂商: "Google",
    家族系列: "Gemini",
    模型定位: "超长上下文旗舰",
    梯队评级: "S+ 顶尖旗舰",
    ...
    输入价格_美元: 2.00,
    输出价格_美元: 8.00,
    核心优势: "原生全模态（视音频/超大型多文件仓库）理解断层领先；200 万超长窗口保持 99.5%+ 针大海捞针命中率。",
    短板风险: "在极长上下文（>100 万 tokens）时首字延迟 (TTFT) 显著上升；中转站支持全量 2M 窗口的节点相对有限。",
    推荐场景: "数小时音视频会议跨片段关联分析、全量代码仓库全链路依赖追踪、海量档案库深度研判。",
    官方发布时间: "2026-05",
  },
  {
    模型名称: "智谱 GLM-5.2 (推理旗舰)",
    厂商: "智谱AI",
    家族系列: "GLM",
    模型定位: "深度思考推理",
    梯队评级: "S 头部第一梯队",
    ...
    输入价格_美元: 1.50,
    输出价格_美元: 6.00,
    核心优势: "智谱最新原生思考大模型（中转站 glm-5.2）；中文深层逻辑、高考与数理奥赛表现强悍，具备自主工具扩展调用体系。",
    短板风险: "英文小语种学术问答与海外顶级模型相比稍逊一线；高并发时偶有思考超时。",
    推荐场景: "国内金融与财报纵深研判、复杂政企工作流、合同法条逐项排查、国产本地化智能体中台。",
    官方发布时间: "2026-06",
  },
  {
