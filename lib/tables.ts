...
export const TABLES: TableConfig[] = [
  ...
  {
    id: "llm_benchmarks",
    tableId: "tblDEYFxNErNcIee",
    displayName: "大模型评测天梯",
    description: "主流大模型（Claude / GPT / Gemini / GLM / DeepSeek / 通义千问）实测评分、竞技场天梯与工程基准",
    primaryKey: "模型名称",
    titleField: "模型名称",
    subtitleField: "厂商",
    color: "purple",
    fields: [
      { key: "模型名称", label: "模型名称", type: "text", searchable: true, sortable: true, primary: true },
      { key: "厂商", label: "厂商", type: "single-select", filterable: true, primary: true },
      { key: "家族系列", label: "家族", type: "single-select", filterable: true, primary: true },
      { key: "模型定位", label: "定位", type: "single-select", filterable: true, primary: true },
      { key: "梯队评级", label: "梯队", type: "single-select", filterable: true, primary: true },
      { key: "LMSYS总榜Elo", label: "Arena 总分", type: "number", sortable: true, primary: true },
      { key: "LMSYS代码Elo", label: "代码 Elo", type: "number", sortable: true },
      { key: "LMSYS数学Elo", label: "数学 Elo", type: "number", sortable: true },
      { key: "SWE_bench_Verified", label: "SWE-bench %", type: "number", sortable: true, primary: true },
      { key: "AIME_2024", label: "AIME %", type: "number", sortable: true, primary: true },
      { key: "GPQA_Diamond", label: "GPQA %", type: "number", sortable: true },
      { key: "MATH_500", label: "MATH-500 %", type: "number", sortable: true },
      { key: "上下文窗口", label: "上下文", type: "text", primary: true },
      { key: "最大输出", label: "最大输出", type: "text" },
      { key: "输入价格_美元", label: "输入 $/1M", type: "number", sortable: true, primary: true },
      { key: "输出价格_美元", label: "输出 $/1M", type: "number", sortable: true },
      { key: "核心优势", label: "核心优势", type: "longtext", searchable: true },
      { key: "短板风险", label: "短板风险", type: "longtext" },
      { key: "推荐场景", label: "推荐场景", type: "text", searchable: true },
      { key: "官方发布时间", label: "发布时间", type: "text", sortable: true },
    ],
  },
];
